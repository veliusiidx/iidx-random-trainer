...
int main()
{
	...
	cout << "Go back to Bistro now." << endl;
	...
	else 
	{
		...
		else 
		{
			...
			DWORD64 miscrec1 = Base + 0x0462118;
			DWORD64 miscrec2 = Base + 0x0462620;
			DWORD64 miscrec3 = Base + 0x0462124;
			DWORD64 miscrec4 = Base + 0x0462130;
			DWORD64 miscrec5 = Base + 0x046213C;
			DWORD64 miscrec6 = Base + 0x0462148;
			DWORD64 miscrec7 = Base + 0x0462154;
			DWORD64 miscrec8 = Base + 0x0462160;
			char helloworld[] = "PRESS TAB TO ENTER RAN";
			char helloworld2[] = "PRESS BACKSLASH TO ENTER P2 RAN";
			char credit[] = "FREE PLAY";
			DWORD64 textaddress = Base + 0x0A7E330;
			DWORD old;
			...
			while (GetMessage(&msg, NULL, 0, 0) != 0)
			{
				...
				if (msg.wParam == 9) 
				{
					...
					for (int i = 0; i < 7; i++) {
						...
						case 0:
							key = i + 1;
							address = Base + 0x4CBBD70;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 1:
							key = i + 1;
							address = Base + 0x4CBBD74;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 2:
							key = i + 1;
							address = Base + 0x4CBBD78;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 3:
							key = i + 1;
							address = Base + 0x4CBBD7C;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 4:
							key = i + 1;
							address = Base + 0x4CBBD80;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 5:
							key = i + 1;
							address = Base + 0x4CBBD84;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 6:
							key = i + 1;
							address = Base + 0x4CBBD88;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						default:
				...
				if (msg.wParam == 11)
				{
					...
					for (int i = 0; i < 7; i++) {
						...
						case 0:
							key = i + 1;
							address = Base + 0x4CBBD90;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 1:
							key = i + 1;
							address = Base + 0x4CBBD94;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 2:
							key = i + 1;
							address = Base + 0x4CBBD98;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 3:
							key = i + 1;
							address = Base + 0x4CBBD9C;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 4:
							key = i + 1;
							address = Base + 0x4CBBDA0;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 5:
							key = i + 1;
							address = Base + 0x4CBBDA4;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						case 6:
							key = i + 1;
							address = Base + 0x4CBBDA8;
							ReadProcessMemory(handle, (BYTE*)address, &read, sizeof(read), 0);
							randomRead[read] = key + '0';
							break;
						default:
